...
public class Framework extends Canvas {
     ...
     */
    public static enum GameState{STARTING, VISUALIZING, GAME_CONTENT_LOADING, MAIN_MENU, BROWSER_MENU, OPTIONS, PLAYING, GAMEOVER, DESTROYED}
    /**
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use w a d keys to controle the player.", frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("Press any key to start the Game.", frameWidth / 2 - 100, frameHeight / 2 + 30);
                //g2d.drawString("Press B- key to start the Server Browser.", frameWidth / 2 - 100, frameHeight / 2 + 60);
