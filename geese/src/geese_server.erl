...
%% c(geese_player), c(geese_coordinator), c(geese_player), c(geese_table), c(geese_dispatcher), c(geese_coordinator_backup), c(geese_sup), c(game_state), c(game_logic), c(action_db), c(geese_server), geese_sup:start_link(3010).
