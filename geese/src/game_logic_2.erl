...
iterate_move(Vel, Pos, Hp, Level_list) ->
    ...
    {_Border_hit, Point_1, Type_1} = border_hit(Line_1, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit, Point_2, Type_2} = border_hit(Line_2, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit, Point_3, Type_3} = border_hit(Line_3, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit, Point_4, Type_4} = border_hit(Line_4, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
	...
	{Origin, Short, Type} ->
		...
		hor ->
		    ...
		    {_Border, Snd_point_1, _Type} = border_hit(Snd_line_1, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_2, _Type} = border_hit(Snd_line_2, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_3, _Type} = border_hit(Snd_line_3, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_4, _Type} = border_hit(Snd_line_4, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		...
		ver ->
		    ...
		    Snd_line_3 = make_line(Short, Snd_ideal_point_3),
		    Snd_line_4 = make_line(Short, Snd_ideal_point_4),
		    {_Border, Snd_point_1, _Type} = border_hit(Snd_line_1, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_2, _Type} = border_hit(Snd_line_2, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_3, _Type} = border_hit(Snd_line_3, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border, Snd_point_4, _Type} = border_hit(Snd_line_4, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    Snd_short_1 = shortest_distance(Short, Snd_ideal_point_1, Snd_point_1),
		    Snd_short_2 = shortest_distance(Short, Snd_ideal_point_2, Snd_point_2),
		    Snd_short_3 = shortest_distance(Short, Snd_ideal_point_3, Snd_point_3),
		    Snd_short_4 = shortest_distance(Short, Snd_ideal_point_4, Snd_point_4),
