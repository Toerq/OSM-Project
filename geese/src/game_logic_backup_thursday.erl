-module(game_logic_backup_thursday).
-compile(export_all).
...
make_new_state() ->
    {{3.7, 
      ...
      {500, 500}, 
      12.6, 
      [{{0, 0},{800, 600}},{{500,100},{600,100}},{{599,100},{599,200}},{{250,100},{400,100}},{{500,200},{650,200}},{{500,210},{650,210}},  {{500,200},{500,210}}, {{650,200},{650,210}} ,{{-10,-10},{810,5}}]}, 
     {[],[]}}.
...
get_borders([O| T], {Aux_v, Aux_h}) ->
    ...
    Top_h = {{X_start - 20, X_end + 20}, Y_end},
...
iterate_move(Vel, Pos, Hp, Level_list) ->
    ...
    {_Border_hit1, Point_1, Type_1} = border_hit(Line_1, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit2, Point_2, Type_2} = border_hit(Line_2, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit3, Point_3, Type_3} = border_hit(Line_3, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
    {_Border_hit4, Point_4, Type_4} = border_hit(Line_4, Vertical_list, Horizontal_list, Dummy_value_v, Dummy_value_h),
	...
	{Origin, Short, Type} ->
		...
		hor ->
		    ...
		    {Snd_x_1, Snd_y_1} = {New_short_x, New_short_y},  
		    {Snd_x_2, Snd_y_2} = {New_short_x + ?PLAYERWIDTH, New_short_y},
		    {Snd_x_3, Snd_y_3} = {New_short_x, New_short_y + ?PLAYERHEIGHT},
		    {Snd_x_4, Snd_y_4} = {New_short_x + ?PLAYERWIDTH, New_short_y + ?PLAYERHEIGHT},
		    ...
		    Snd_line_1 = make_line(Short, Snd_ideal_point_1),		    
		    Snd_line_2 = make_line(Short, Snd_ideal_point_2),		    
		    Snd_line_3 = make_line(Short, Snd_ideal_point_3),
		    Snd_line_4 = make_line(Short, Snd_ideal_point_4),
		    {_Border1, Snd_point_1, _Type1} = border_hit(Snd_line_1, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border2, Snd_point_2, _Type2} = border_hit(Snd_line_2, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border3, Snd_point_3, _Type3} = border_hit(Snd_line_3, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    {_Border4, Snd_point_4, _Type4} = border_hit(Snd_line_4, Vertical_list, [], Dummy_value_v, Dummy_value_h),
		    Snd_short_1 = shortest_distance(Short, Snd_ideal_point_1, Snd_point_1),
		    Snd_short_2 = shortest_distance(Short, Snd_ideal_point_2, Snd_point_2),
		    Snd_short_3 = shortest_distance(Short, Snd_ideal_point_3, Snd_point_3),
		    Snd_short_4 = shortest_distance(Short, Snd_ideal_point_4, Snd_point_4),
			...
			{Snd_origin, Snd_short, _Type} ->
			    ...
			    {{0.0, New_y_vel}, Snd_new_short, Hp}
		    end;
		%%Ver%%
		ver ->
		    %% your new pos will be Short() and you will lose your vertical vel,
		    ...
		    Snd_line_3 = make_line(Short, Snd_ideal_point_3),
		    Snd_line_4 = make_line(Short, Snd_ideal_point_4),
		    {_Border1, Snd_point_1, _Type1} = border_hit(Snd_line_1, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border2, Snd_point_2, _Type2} = border_hit(Snd_line_2, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border3, Snd_point_3, _Type3} = border_hit(Snd_line_3, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    {_Border4, Snd_point_4, _Type4} = border_hit(Snd_line_4, [], Horizontal_list, Dummy_value_v, Dummy_value_h),
		    Snd_short_1 = shortest_distance(Short, Snd_ideal_point_1, Snd_point_1),
		    Snd_short_2 = shortest_distance(Short, Snd_ideal_point_2, Snd_point_2),
		    Snd_short_3 = shortest_distance(Short, Snd_ideal_point_3, Snd_point_3),
		    Snd_short_4 = shortest_distance(Short, Snd_ideal_point_4, Snd_point_4),
			...
			{Snd_origin, Snd_short, _Type} ->
			    ...
			    {Snd_short_x, Snd_short_y} = Snd_short,
			    Snd_new_short = {Snd_short_x + Snd_diff_x, Snd_short_y + Snd_diff_y},
			    {{New_x_vel, 0.0}, Snd_new_short, Hp}
		    end
